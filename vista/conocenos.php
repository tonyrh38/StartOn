  ...
  <body>
    <?php require("common/header.php")?>
  	<div id="container">
  		...
  		<div class="row">
        <div id="bconocenos" class ="burbuja">
      ...
      <div class="row_content">
        <div class="conocenosCard">
          ...
          <img src = "../resources/img/info/pabloa.jpg">
          ...
          <img src = "../resources/img/info/pablof.jpg">
          ...
          <img src = "../resources/img/info/eric.jpg">
    	...
    	<div class="row_content">
          ...
          <img src = "../resources/img/info/jeni.jpg">
    	...
    	<div class="row_content">
          ...
          <img src = "../resources/img/info/cris.jpg">
          ...
          <img src = "../resources/img/info/piña.jpg">
    	...
    	<div class="row_content">
          ...
          <img src = "../resources/img/info/toni.jpg">
